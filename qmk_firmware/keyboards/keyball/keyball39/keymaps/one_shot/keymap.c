...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [DEF] = LAYOUT_universal(
    ...
    G(KC_L)     , KC_PSCR  , _______  , KC_LSFT      , LA_NAV      , KC_ESC,               KC_SPC,   LA_SYM    , XXXXXXX  , XXXXXXX  , XXXXXXX  , SCRL_TO
  ),
  ...
  [SYM] = LAYOUT_universal(
    ...
    _______     , MACRO1   , _______  , _______      , _______      , KC_TAB    ,          _______ ,  _______   , XXXXXXX  , XXXXXXX  , XXXXXXX  , _______
  ),
